import { CatmullRomCurve3, DoubleSide, Group, Mesh, MeshBasicMaterial,PlaneGeometry, PlaneBufferGeometry, Texture, TubeGeometry, Vector3 } from "three";
...
// 创建柱状
export const createLightPillar = (options, punctuation) => {
