...
export default {
	...
	methods: {
		playSVG() {
			const iconPath = document.getElementsByClassName('ipIconPath'); // 获取 path 标签
			for (let i = 0; i < iconPath.length; i++) {
				let path = iconPath[i];
				const pathInitFill = path.getAttribute('fill');
				path.style.fill = '#FFFFFF';
				path.style.stroke = pathInitFill;
